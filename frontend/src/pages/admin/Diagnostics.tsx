  ...
  return (
    <div className="py-6 space-y-6">
      ...
      <p className="text-sm text-muted-foreground">
        ...
        the Alpha Live Trading community — secrets and tokens are never included.
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Section icon={Settings} title="Build">
          <div>
            <KV label="Alpha Live Trading" value={info?.build.openalgo_version} />
            <KV label="Alpha Live Trading SDK" value={info?.build.openalgo_sdk_version} />
