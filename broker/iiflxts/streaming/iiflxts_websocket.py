...
from broker.iiflxts.baseurl import BASE_URL, INTERACTIVE_URL, MARKET_DATA_URL


class IIFLXTSWebSocketClient:
    """
    ...
    def __init__(self, api_key: str, api_secret: str, user_id: str, base_url: str = None):
        ...
        # Logger
        self.logger = logging.getLogger("iiflxts_websocket")
