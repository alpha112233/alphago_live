...
class BrokerData:
    def __init__(self, auth_token, feed_token=None, user_id=None):
        """Initialize IIFLXTS data handler with authentication token"""
        self.auth_token = auth_token
        self.feed_token = feed_token
        self.user_id = user_id

        # Map common timeframe format to IIFLXTS intervals
        self.timeframe_map = {
            "1s": "1",
            "1m": "60",
            "2m": "120",
    ...
    def _fetch_market_data(
        ...
        """
        Helper method to fetch market data from IIFLXTS API
        Args:
    ...
    def _process_multiquotes_batch(self, symbols: list) -> list:
        ...
        try:
            ...
            if not response or response.get("type") != "success":
                ...
                raise Exception(f"Error from IIFLXTS API: {error_msg}")
    ...
    def get_history(self, symbol, exchange, timeframe, from_date, to_date):
        ...
        try:
            ...
            while current_start <= to_date:
                ...
                # IIFLXTS expects MMM DD YYYY HHMMSS in IST
                ...
                if not response or response.get("type") != "success":
                    ...
                    raise Exception(
                        f"Error from IIFLXTS API: {response.get('description', 'Unknown error')}"
                    )
